...
where left(last_name, 1) like'[À-Åà-å]' and right(last_name, 2) not in ('è÷', 'È×')
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            PRINT N'Çàïèñü â òàáëèöå óñïåøíî îáíîâëåíà';
        END
        ELSE
        BEGIN
            EXEC sp_executesql @InsertIntoTableSQL;
            PRINT N'Çàïèñü óñïåøíî äîáàâëåíà â òàáëèöó.';
        END
    END
    ELSE
    BEGIN
